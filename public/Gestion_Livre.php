  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (error) {
      const messages = {
        ...
        nbexemplaire_inferieur: { title: 'Nombre d\'exemplaire',        text: 'Le nombre d\'exemplaire est inférieur à au nombre de livre disponible'},
        auteur_unknown: { title: 'Auteur inconnu',        text: 'Aucun auteur ne correspond.'},
        editeur_unknown: { title: 'Editeur inconnu',        text: 'Aucun éditeur ne correspond.'},
        disponible_inferieur: { title: 'Nombre de livre disponible',        text: 'Le nombre de livre livre disponible ne peut pas ètre negatif'},
        exemplaire_inferieur: { title: 'Nombre d\'exemplaire',        text: 'Le nombre d\'exemplaire ne peut pas ètre négatif'},
      };
      Swal.fire({
        icon: 'error',
